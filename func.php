    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3"> GAU CMS </div>
            </a>
            ...
            <!-- Nav Item - Tables-->
            <li class="nav-item">
                <a class="nav-link" href="ders_kayit.php">
                    <i class="fas fa-fw fa-table"></i>
                    <span> Class Assignment </span></a>
                </li> 
            ...
            <!-- Sidebar Toggler (Sidebar) paneli küçültme --> 
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?=$_SESSION['ad'];?></span>
    ...
    <footer class="sticky-footer bg-white">
        <div class="container my-auto">
            <div class="copyright text-center my-auto">
                <span>Created by Beril Tezcan - 151701022</span>
            </div>
        </div>
    </footer>
    <!-- End of Footer -->
